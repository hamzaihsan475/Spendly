...
This step establishes the **data layer foundation** for the Moneyhabit application.
...
- Opens connection to `moneyhabit.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
    - name: Demo User
    - email: [demo@moneyhabit.com](mailto:demo@moneyhabit.com)
